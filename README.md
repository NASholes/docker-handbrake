...
|`AUTOMATED_CONVERSION_IGNORE_FILE_EXTENSIONS`| Ignore the specified file extensions. Provide a list of file extensions seperated by commas. For example `.nfo,.srt` | (unset) |
